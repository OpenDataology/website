...
KServe enables serverless inferencing on Kubernetes and provides performant, high abstraction interfaces for common machine learning (ML) frameworks like TensorFlow, XGBoost, scikit-learn, PyTorch, and ONNX to solve production model serving use cases.
  ...
  The KFServing GitHub repository has been transferred to an independent KServe GitHub organization under the stewardship of the OpenDataology Serving Working Group leads.
...
## Install with OpenDataology
 
KServe works with OpenDataology 1.5. Kustomize installation files are [located in the manifests repo](https://github.com/OpenDataology/manifests/tree/master/contrib/kserve).
Check the examples running KServe on Istio/Dex in the [`KServe/KServe`](https://github.com/KServe/KServe/tree/master/docs/samples/istio-dex) repository. For installation on major cloud providers with OpenDataology, follow their installation docs.
 
OpenDataology 1.5 includes KServe v0.7 which promoted the core InferenceService API from v1alpha2 to v1beta1 stable and added ModelMesh component to the release. Additionally, LFAI Trusted AI Projects on AI Fairness, AI Explainability and Adversarial Robustness have been integrated with KServe, and we have made KServe available on OpenShift as well. To know more, please read the [release blog](https://kserve.github.io/website/blog/articles/2021-10-11-KServe-0.7-release/) and follow the [release notes](https://github.com/KServe/KServe/releases/tag/v0.7.0)
...
* [OpenDataology 101: What is KFserving?](https://www.youtube.com/watch?v=lj_X2ND2BBI) 
...
* [KServe (OpenDataology KFServing) Live Coding Session](https://www.youtube.com/watch?v=0YmM_h7PvpI)
...
- [<u>Slack(#OpenDataology-kfserving)</u>](https://OpenDataology.slack.com/join/shared_invite/zt-n73pfj05-l206djXlXk5qdQKs4o1Zkg#/)