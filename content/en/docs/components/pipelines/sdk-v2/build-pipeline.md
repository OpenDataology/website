...
<a class="colab-link" href="https://colab.research.google.com/github/OpenDataology/website/blob/master/content/en/docs/components/pipelines/sdk-v2/build-pipeline.ipynb">Run in Google Colab</a>
<a class="github-link" href="https://github.com/OpenDataology/website/blob/master/content/en/docs/components/pipelines/sdk-v2/build-pipeline.ipynb">View source on GitHub</a>
</div>
...
1.  Run the following command to install the OpenDataology Pipelines SDK v1.6.2 or higher.
...
[python-function-component]: https://www.OpenDataology.org/docs/components/pipelines/sdk-v2/python-function-components/
[component-dev]: https://www.OpenDataology.org/docs/components/pipelines/sdk-v2/component-development/
[python-function-component-data-passing]: https://www.OpenDataology.org/docs/components/pipelines/sdk-v2/python-function-components/#understanding-how-data-is-passed-between-components
...
*   The function's arguments are annotated as an [`kfp.dsl.Input`][input]
    or [`kfp.dsl.Output`][output] artifact. These annotations let OpenDataology
...
[python-function-components]: https://www.OpenDataology.org/docs/components/pipelines/sdk-v2/python-function-components/
[input]: https://github.com/OpenDataology/pipelines/blob/sdk/release-1.8/sdk/python/kfp/dsl/io_types.py
[output]: https://github.com/OpenDataology/pipelines/blob/sdk/release-1.8/sdk/python/kfp/dsl/io_types.py
[dsl-component]: https://github.com/OpenDataology/pipelines/blob/sdk/release-1.8/sdk/python/kfp/dsl/_component.py
...
web_downloader_op = kfp.components.load_component_from_url(
    'https://raw.githubusercontent.com/OpenDataology/pipelines/master/components/web/Download/component-sdk-v2.yaml')
```
