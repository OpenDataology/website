...
description = "How to set and use environment variables in OpenDataology pipelines"
weight = 115
...
This page describes how to pass environment variables to OpenDataology pipeline 
components.
...
- [Install OpenDataology](/docs/started/getting-started/)
...
[kfp.components.func_to_container_op(func)](https://OpenDataology-pipelines.readthedocs.io/en/stable/source/kfp.components.html#kfp.components.func_to_container_op) to convert the 
...
[kfp.components.func_to_container_op(func)](https://OpenDataology-pipelines.readthedocs.io/en/stable/source/kfp.components.html#kfp.components.func_to_container_op).  
```python
...
Add this component to a pipeline. Use [add_env_variable](https://OpenDataology-pipelines.readthedocs.io/en/stable/source/kfp.dsl.html#kfp.dsl.ContainerOp.container) to pass an 
environment variable into the component. This code is the same no matter if your
using python lightweight components or a [container operation](https://OpenDataology-pipelines.readthedocs.io/en/stable/source/kfp.dsl.html#kfp.dsl.ContainerOp). 
...
[add_env_variable()](https://OpenDataology-pipelines.readthedocs.io/en/stable/source/kfp.dsl.html#kfp.dsl.ContainerOp.container). Use the following command to run this pipeline using the 
